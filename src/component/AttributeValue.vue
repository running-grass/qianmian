...
<template>
  <input
    v-if="attr.attributeType === 'string'"
    type="text"
    v-model="attr.data"
    class="input"
  ...
  <el-switch
    ...
    @change="changeAttrLocal"
    v-model="attr.data as boolean"
  />
  <el-select
    v-else-if="attr.attributeType === 'enum'"
    v-model="attr.data as string"
    placeholder="Select"
    size="large"
    style="width: 240px"
    @change="changeAttrLocal"
  ...
  <el-select
    v-else-if="attr.attributeType === 'enums'"
    v-model="attr.data as string"
    multiple
    placeholder="Select"
    size="large"
  ...
  <el-date-picker
    v-else-if="attr.attributeType === 'datetime'"
    v-model="attr.data as Date"
    type="datetime"
    placeholder="请选择时间"
    @change="changeAttrLocal"
  />
